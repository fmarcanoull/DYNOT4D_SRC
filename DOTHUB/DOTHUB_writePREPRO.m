function [prepro, preproFileName] = DOTHUB_writePREPRO(preproFileName,logData,dod,tDOD,SD3D,s,dcAvg,dcAvgStd,tHRF,condNames,SD2D,dodTrials,yTrials)
...
%
% dodTrials,yTrials : FM MODIFICACION 2023.11.02 --> data volúmenes individuales
% ####################### OUTPUTS #########################################
%
...
%
%
%                      prepro.dodTrials, yTrials: data volúmenes
%                      individuales (FM MODIFICACION 2023.11.02)
%
% ####################### Dependencies ####################################
% #########################################################################
% RJC, UCL, April 2020
...
if exist('yTrials','var')
    if ~isempty(yTrials)
        prepro.yTrials = yTrials;
    end
end

if exist('dodTrials','var')
    if ~isempty(dodTrials)
        prepro.dodTrials = dodTrials;
    end
end
