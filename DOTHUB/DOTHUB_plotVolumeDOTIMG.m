...
for i = 1:nSubplot
    ...
    %%%% FM MODIFICACION 2023-10-26. Solo ocurre cuando la imagen es toda
    %%%% nula (img == [0 ... 0]), puede que por algún error o por el análisis que se ha hecho. Revisar.
    %%%% Por ahora, este paño caliente.
    if all(cRange == [0 0])
        cRange = [0 1];
    end
