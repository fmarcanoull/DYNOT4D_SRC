...
ml = SD.MeasList;
%%%% FM MODIFICACION. No toma en cuenta los canales eliminados
%%%% Por ejemplo, los colocalizados, para que rho == 0 no de Nans.
%ml = ml(find(SD.MeasListAct),:,:,:);
